...
public class OrdersController {
    ...
    @FXML private TableColumn<Ordine, Integer> idOrdine;
    @FXML private TableColumn<Ordine, String> emailUtente;
    @FXML private TableColumn<Ordine, LocalDate> dataOrdine;
